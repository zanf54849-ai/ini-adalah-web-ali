                            ...
                            <div class="row g-4 product">
                                    ...
                                    <div class="product-item rounded wow fadeInUp" data-wow-delay="0.5s">
                                        <div class="product-item-inner border rounded">
                                            ...
                                            <div class="text-center rounded-bottom p-4">
                                                ...
                                                <a href="#" class="d-block h4">Small Suitcase 16 - 24 Inches <br> </a>
                                                <del class="me-2 fs-5">IDR200K</del>
                                                <span class="text-primary fs-5">IDR150K</span>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="product-item rounded wow fadeInUp" data-wow-delay="0.5s">
                                        <div class="product-item-inner border rounded">
                                            <div class="product-item-inner-item">
                                                <img src="img/product-11.png" class="img-fluid w-100 rounded-top product-img-fixed" alt="">
                                                <div class="product-new">New</div>
                                                <div class="product-details">
                                                    <a href="#"><i class="fa fa-eye fa-1x"></i></a>
                                                </div>
                                            ...
                                            <div class="text-center rounded-bottom p-4">
                                                <a href="#" class="d-block mb-2">Suitcase</a>
                                                <a href="#" class="d-block h4">Medium / Large Suitcase up yo 28 Inch <br> </a>
                                ...
                                <div class="col-12 wow fadeInUp" data-wow-delay="0.1s">
                                    <div class="pagination d-flex justify-content-center mt-5">
                                        ...
                                        <a href="/shop?page=1" class="active rounded">1</a>
