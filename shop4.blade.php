                            ...
                            <div class="row g-4 product">
                                ...
                                <div class="col-lg-4">
                                    <div class="product-item rounded wow fadeInUp" data-wow-delay="0.1s">
                                        <div class="product-item-inner border rounded">
                                            <div class="product-item-inner-item">
                                                <img src="img/product-30.png" class="img-fluid w-80 rounded-top product-img-fixed" alt="">
                                            ...
                                            <div class="text-center rounded-bottom p-4">
                                                ...
                                                <a href="#" class="d-block h4">Wash Hip Seat</a>
                                ...
                                <div class="col-lg-4">
                                    <div class="product-item rounded wow fadeInUp" data-wow-delay="0.3s">
                                        <div class="product-item-inner border rounded">
                                            <div class="product-item-inner-item">
                                                <img src="img/product-31.png" class="img-fluid w-100 rounded-top product-img-fixed" alt="">
                                            ...
                                            <div class="text-center rounded-bottom p-4">
                                                ...
                                                <a href="#" class="d-block h4">Wash Diapersbag<br> </a>
                                                <del class="me-2 fs-5">IDR150K</del>
                                                <span class="text-primary fs-5">IDR100K</span>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="product-item rounded wow fadeInUp" data-wow-delay="0.5s">
                                        <div class="product-item-inner border rounded">
                                            <div class="product-item-inner-item">
                                                <img src="img/product-32.png" class="img-fluid w-100 rounded-top product-img-fixed" alt="">
                                                <div class="product-details">
                                                    <a href="#"><i class="fa fa-eye fa-1x"></i></a>
                                                </div>
                                            </div>
                                            <div class="text-center rounded-bottom p-4">
                                                ...
                                                <a href="#" class="d-block h4">Full White Canvas Shoes - High<br> </a>
                                ...
                                <div class="col-lg-4">
                                    <div class="product-item rounded wow fadeInUp" data-wow-delay="0.7s">
                                        <div class="product-item-inner border rounded">
                                            <div class="product-item-inner-item">
                                                <img src="img/product-33.png" class="img-fluid w-100 rounded-top product-img-fixed" alt="">
                                                <div class="product-new">New</div>
                                                <div class="product-details">
                                                    <a href="#"><i class="fa fa-eye fa-1x"></i></a>
                                                </div>
                                            ...
                                            <div class="text-center rounded-bottom p-4">
                                                <a href="#" class="d-block mb-2">Shoes</a>
                                                <a href="#" class="d-block h4">Wash Basketball Shoes -Low<br></a>
                                                <del class="me-2 fs-5">IDR100K</del>
                                                <span class="text-primary fs-5">IDR75K</span>
                                            </div>
                                        </div>
                                        <div
                                            class="product-item-add border border-top-0 rounded-bottom  text-center p-4 pt-0">
                                ...
                                <div class="col-lg-4">
                                    <div class="product-item rounded wow fadeInUp" data-wow-delay="0.1s">
                                        <div class="product-item-inner border rounded">
                                            <div class="product-item-inner-item">
                                                <img src="img/product-34.png" class="img-fluid w-100 rounded-top product-img-fixed" alt="">
                                                <div class="product-sale">Sale</div>
                                                <div class="product-details">
                                                    <a href="#"><i class="fa fa-eye fa-1x"></i></a>
                                                </div>
                                            ...
                                            <div class="text-center rounded-bottom p-4">
                                                <a href="#" class="d-block mb-2">Shoes</a>
                                                <a href="#" class="d-block h4">Washing Basketball Shoes/Boots/Mountain Shoes/PDL Shoes</a>
                                                <del class="me-2 fs-5">IDR100K</del>
                                                <span class="text-primary fs-5">IDR85k</span>
                                            </div>
                                        </div>
                                ...
                                <!--        <div class="product-item-inner border rounded">-->
                                <!--            <div class="product-item-inner-item">-->
                                <!--                <img src="img/product-35.png" class="img-fluid w-100 rounded-top product-img-fixed" alt="">-->
                                <!--                <div class="product-details">-->
                                <!--                    <a href="#"><i class="fa fa-eye fa-1x"></i></a>-->
                                <!--                </div>-->
                                <!--            </div>-->
                                ...
                                <!--        <div class="product-item-inner border rounded">-->
                                <!--            <div class="product-item-inner-item">-->
                                <!--                <img src="img/product-36.png" class="img-fluid w-100 rounded-top product-img-fixed" alt="">-->
                                <!--                <div class="product-new">New</div>-->
                                <!--                <div class="product-details">-->
                                <!--                    <a href="#"><i class="fa fa-eye fa-1x"></i></a>-->
                                <!--                </div>-->
                                ...
                                <!--        <div class="product-item-inner border rounded">-->
                                <!--            <div class="product-item-inner-item">-->
                                <!--                <img src="img/product-37.png" class="img-fluid w-100 rounded-top product-img-fixed" alt="">-->
                                <!--                <div class="product-new">New</div>-->
                                <!--                <div class="product-details">-->
                                <!--                    <a href="#"><i class="fa fa-eye fa-1x"></i></a>-->
                                <!--                </div>-->
                                ...
                                <!--        <div class="product-item-inner border rounded">-->
                                <!--            <div class="product-item-inner-item">-->
                                <!--                <img src="img/product-38.png" class="img-fluid w-100 rounded-top product-img-fixed" alt="">-->
                                <!--                <div class="product-new">New</div>-->
                                <!--                <div class="product-details">-->
                                <!--                    <a href="#"><i class="fa fa-eye fa-1x"></i></a>-->
                                <!--                </div>-->
