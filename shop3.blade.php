...
<div class="container-fluid px-5 py-4 d-none d-lg-block">
    ...
    </div> <!-- ✅ TUTUP ROW 1 DI SINI -->
    
    <!-- Row 2: Hasil Pencarian (PISAH DARI ROW 1) -->
                ...
                <div class="col-lg-3 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <a href="{{ route('order.form') }}">
                        <div class="position-relative">
                            <img src="img/product-30.png" class="img-fluid w-100 rounded" alt="Sale Banner">
                            ...
                            <div class="row g-4 product">
                                ...
                                <div class="col-lg-4">
                                    <div class="product-item rounded wow fadeInUp" data-wow-delay="0.1s">
                                        <div class="product-item-inner border rounded">
                                            <div class="product-item-inner-item">
                                                <img src="img/product-21.png" class="img-fluid w-80 rounded-top product-img-fixed" alt="">
                                            ...
                                            <div class="text-center rounded-bottom p-4">
                                                <a href="#" class="d-block mb-2">Helmet</a>
                                                <a href="#" class="d-block h4">Full Face Helmet</a>
                                                <del class="me-2 fs-5">IDR100K</del>
                                                <span class="text-primary fs-5">IDR85K</span>
                                            </div>
                                        </div>
                                        <div class="product-item-add border border-top-0 rounded-bottom text-center p-4 pt-0">
                                            <a href="{{ route('order.form') }}" class="btn btn-primary border-secondary rounded-pill py-2 px-4 mb-4">
                                ...
                                <div class="col-lg-4">
                                    <div class="product-item rounded wow fadeInUp" data-wow-delay="0.3s">
                                        <div class="product-item-inner border rounded">
                                            <div class="product-item-inner-item">
                                                <img src="img/product-22.png" class="img-fluid w-100 rounded-top product-img-fixed" alt="">
                                            ...
                                            <div class="text-center rounded-bottom p-4">
                                                <a href="#" class="d-block mb-2">Helmet</a>
                                                <a href="#" class="d-block h4">Half Face Helmet<br> </a>
                                                <del class="me-2 fs-5">IDR100K</del>
                                                <span class="text-primary fs-5">IDR60K</span>
                                            </div>
                                        </div>
                                        <div
                                ...
                                <div class="col-lg-4">
                                    <div class="product-item rounded wow fadeInUp" data-wow-delay="0.5s">
                                        <div class="product-item-inner border rounded">
                                            <div class="product-item-inner-item">
                                                <img src="img/product-23.png" class="img-fluid w-100 rounded-top product-img-fixed" alt="">
                                                <div class="product-details">
                                                    <a href="#"><i class="fa fa-eye fa-1x"></i></a>
                                                </div>
                                            </div>
                                            <div class="text-center rounded-bottom p-4">
                                                <a href="#" class="d-block mb-2">Helmet</a>
                                                <a href="#" class="d-block h4">Children's Helmet<br> </a>
                                                <del class="me-2 fs-5">IDR100K</del>
                                                <span class="text-primary fs-5">IDR45K</span>
                                            </div>
                                        </div>
                                        <div
                                            class="product-item-add border border-top-0 rounded-bottom  text-center p-4 pt-0">
                                ...
                                <div class="col-lg-4">
                                    <div class="product-item rounded wow fadeInUp" data-wow-delay="0.7s">
                                        <div class="product-item-inner border rounded">
                                            <div class="product-item-inner-item">
                                                <img src="img/product-24.png" class="img-fluid w-100 rounded-top product-img-fixed" alt="">
                                                <div class="product-new">New</div>
                                                <div class="product-details">
                                                    <a href="#"><i class="fa fa-eye fa-1x"></i></a>
                                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="product-item rounded wow fadeInUp" data-wow-delay="0.1s">
                                        <div class="product-item-inner border rounded">
                                            <div class="product-item-inner-item">
                                                <img src="img/product-25.png" class="img-fluid w-100 rounded-top product-img-fixed" alt="">
                                                <div class="product-sale">Sale</div>
                                                <div class="product-details">
                                                    <a href="#"><i class="fa fa-eye fa-1x"></i></a>
                                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="product-item rounded wow fadeInUp" data-wow-delay="0.3s">
                                        <div class="product-item-inner border rounded">
                                            <div class="product-item-inner-item">
                                                <img src="img/product-26.png" class="img-fluid w-100 rounded-top product-img-fixed" alt="">
                                                <div class="product-details">
                                                    <a href="#"><i class="fa fa-eye fa-1x"></i></a>
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="product-item rounded wow fadeInUp" data-wow-delay="0.5s">
                                        <div class="product-item-inner border rounded">
                                            <div class="product-item-inner-item">
                                                <img src="img/product-27.png" class="img-fluid w-100 rounded-top product-img-fixed" alt="">
                                                <div class="product-new">New</div>
                                                <div class="product-details">
                                                    <a href="#"><i class="fa fa-eye fa-1x"></i></a>
                                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="product-item rounded wow fadeInUp" data-wow-delay="0.5s">
                                        <div class="product-item-inner border rounded">
                                            <div class="product-item-inner-item">
                                                <img src="img/product-28.png" class="img-fluid w-100 rounded-top product-img-fixed" alt="">
                                                <div class="product-new">New</div>
                                                <div class="product-details">
                                                    <a href="#"><i class="fa fa-eye fa-1x"></i></a>
                                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="product-item rounded wow fadeInUp" data-wow-delay="0.5s">
                                        <div class="product-item-inner border rounded">
                                            <div class="product-item-inner-item">
                                                <img src="img/product-29.png" class="img-fluid w-100 rounded-top product-img-fixed" alt="">
                                                <div class="product-new">New</div>
                                                <div class="product-details">
                                                    <a href="#"><i class="fa fa-eye fa-1x"></i></a>
                                                </div>
                                ...
                                <div class="col-12 wow fadeInUp" data-wow-delay="0.1s">
                                    <div class="pagination d-flex justify-content-center mt-5">
                                        <a href="{{ route('shop2') }}" class="rounded">&laquo;</a>
                                        <a href="{{ route('shop') }}" class="rounded">1</a>
                                        <a href="{{ route('shop2') }}" class="rounded">2</a>
                                        <a href="{{ route('shop3') }}" class="active rounded">3</a>
                                        <a href="{{ route('shop4') }}" class="rounded">4</a>
                                        <a href="{{ route('shop') }}?page=5" class="rounded">5</a>
                                        <a href="{{ route('shop') }}?page=6" class="rounded">6</a>
                                        <a href="{{ route('shop') }}?page=4" class="rounded">&raquo;</a>
                                    </div>
                                </div>
